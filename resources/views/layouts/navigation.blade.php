<nav x-data="{ open: false, countdown: null, timeLeft: 0 }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="flex items-center space-x-4">
                    <!-- Countdown Timer -->
                    <span class="text-sm text-red-500 font-medium" x-text="countdown"></span>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const tokenExpirationTime = {{ Auth::user()->expires_in }};
        const countdownElement = document.querySelector('[x-text="countdown"]');
        ...
        const updateCountdown = () => {
            ...
            if (timeLeft <= 0) {
                ...
                if (!toastShown) {
                    ...
                    setTimeout(() => {
                        window.location.href = "{{ route('adobe.login') }}";
                    }, 2000);
                }
            } else {
